...
def get_args():
    ...
    parser.add_argument("--test_query_subset", type=int, default=-1, 
                        help="Use only the first N queries for testing (-1 uses all). This reduces the 'denominator' of accuracy.")
